...
Revision ID: b43eea443eb5
Revises: 
Create Date: 2025-12-24 13:39:27.053593
...
def upgrade() -> None:
    ...
    op.create_table('construction_costs',
    sa.Column('id', sa.UUID(), nullable=False),
    sa.Column('category', sa.Enum('MATERIALS', 'LABOR', 'EQUIPMENT', 'SERVICES', 'PERMITS', 'OTHER', name='costcategory'), nullable=False),
    sa.Column('item_name', sa.String(length=255), nullable=False),
    sa.Column('description', sa.Text(), nullable=True),
    sa.Column('unit', sa.String(length=50), nullable=False),
    sa.Column('price', sa.Numeric(precision=12, scale=2), nullable=False),
    sa.Column('currency', sa.Enum('USD', 'ARS', name='currency'), nullable=False),
    ...
    op.create_index('idx_cost_search', 'construction_costs', ['category', 'item_name'], unique=False)
    op.create_index('idx_cost_validity', 'construction_costs', ['valid_from', 'valid_until'], unique=False)
    op.create_index(op.f('ix_construction_costs_category'), 'construction_costs', ['category'], unique=False)
    ...
    sa.ForeignKeyConstraint(['cost_id'], ['construction_costs.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index('idx_cost_history_lookup', 'cost_history', ['cost_id', 'recorded_at'], unique=False)
    op.create_index(op.f('ix_cost_history_cost_id'), 'cost_history', ['cost_id'], unique=False)
    op.create_index(op.f('ix_cost_history_recorded_at'), 'cost_history', ['recorded_at'], unique=False)
    op.create_table('properties',
    sa.Column('id', sa.UUID(), nullable=False),
    sa.Column('source', sa.Enum('ARGENPROP', 'ZONAPROP', 'REMAX', 'MERCADOLIBRE', 'MANUAL', name='propertysource'), nullable=False),
    sa.Column('source_url', sa.Text(), nullable=True),
    sa.Column('source_id', sa.String(length=255), nullable=True),
    sa.Column('property_type', sa.Enum('CASA', 'PH', 'DEPARTAMENTO', 'TERRENO', 'LOCAL', 'OFICINA', name='propertytype'), nullable=False),
    sa.Column('operation_type', sa.Enum('VENTA', 'ALQUILER', 'ALQUILER_TEMPORAL', name='operationtype'), nullable=False),
    ...
    sa.Column('semi_covered_area', sa.Numeric(precision=10, scale=2), nullable=True),
    sa.Column('uncovered_area', sa.Numeric(precision=10, scale=2), nullable=True),
    ...
    sa.Column('real_estate_agency', sa.String(length=255), nullable=True),
    sa.Column('contact_info', postgresql.JSONB(astext_type=sa.Text()), nullable=True),
    sa.Column('status', sa.Enum('ACTIVE', 'SOLD', 'RENTED', 'REMOVED', name='propertystatus'), nullable=False),
    ...
    op.create_table('investment_projects',
    sa.Column('id', sa.UUID(), nullable=False),
    ...
    sa.Column('purchase_currency', sa.Enum('USD', 'ARS', name='currency'), nullable=False),
    sa.Column('renovation_budget', sa.Numeric(precision=12, scale=2), nullable=True),
    sa.Column('actual_renovation_cost', sa.Numeric(precision=12, scale=2), nullable=True),
    sa.Column('other_costs', sa.Numeric(precision=12, scale=2), nullable=True),
    sa.Column('estimated_sale_price', sa.Numeric(precision=12, scale=2), nullable=True),
    sa.Column('actual_sale_price', sa.Numeric(precision=12, scale=2), nullable=True),
    sa.Column('total_investment', sa.Numeric(precision=12, scale=2), nullable=True),
    ...
    sa.Column('status', sa.Enum('PLANNING', 'IN_PROGRESS', 'COMPLETED', 'CANCELLED', 'ON_HOLD', name='projectstatus'), nullable=False),
    ...
    op.create_index('idx_project_status', 'investment_projects', ['user_id', 'status'], unique=False)
    op.create_index(op.f('ix_investment_projects_status'), 'investment_projects', ['status'], unique=False)
    ...
    op.create_index('idx_price_history_lookup', 'price_history', ['property_id', 'recorded_at'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_investment_projects_status'), table_name='investment_projects')
    op.drop_index('idx_project_status', table_name='investment_projects')
    ...
    op.drop_index('idx_property_price_range', table_name='properties')
    op.drop_index('idx_property_location', table_name='properties', postgresql_using='gist')
    op.drop_index('idx_properties_location', table_name='properties', postgresql_using='gist')
    op.drop_table('properties')
    op.drop_index(op.f('ix_cost_history_recorded_at'), table_name='cost_history')
    op.drop_index(op.f('ix_cost_history_cost_id'), table_name='cost_history')
    op.drop_index('idx_cost_history_lookup', table_name='cost_history')
    op.drop_table('cost_history')
    op.drop_index(op.f('ix_users_email'), table_name='users')
    op.drop_table('users')
    op.drop_index(op.f('ix_construction_costs_category'), table_name='construction_costs')
    op.drop_index('idx_cost_validity', table_name='construction_costs')
    op.drop_index('idx_cost_search', table_name='construction_costs')
    op.drop_table('construction_costs')
    # ### end Alembic commands ###
